...
def test_array_replace_value() -> None:
    from wexample_helpers.helper.array import array_replace_value
...
def test_array_swap() -> None:
    from wexample_helpers.helper.array import array_swap
...
def test_array_unique() -> None:
    from wexample_helpers.helper.array import array_unique
