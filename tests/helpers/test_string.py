...
def test_string_to_kebab_case():
    ...
    assert string_to_kebab_case("HelloWorld_testCase spaces") == "hello-world-test-case-spaces"
...
def test_string_to_snake_case():
    ...
    # Test with mixed cases and separators
    assert string_to_snake_case("HelloWorld testCase-mixed") == "hello_world_test_case_mixed"
