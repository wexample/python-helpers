...
def test_dict_has_item_by_path():
    data = {"a": {"b": {"c": 1}}}
...
def test_dict_remove_item_by_path():
    data = {"a": {"b": {"c": 1, "d": 2}}}
...
def test_dict_set_item_by_path():
    data = {}
